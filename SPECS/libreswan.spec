...
Version: 4.12
Release: %{?prever:0.}2.1%{?prever:.%{prever}}%{?dist}.3
License: GPLv2
...
# XCP-ng
Patch1000: Fix-compilation-with-older-gcc.patch
...
%changelog
* Wed Jun 26 2024 David Morel <david.morel@vates.tech> - 4.12-2.1
- Sync with CentOS 8 Stream version 4.12-2.el8.3
- Fix compilation issues with gcc 4.8.5
